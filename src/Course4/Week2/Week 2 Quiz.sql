Question 1: Which of the following keywords are required in any query to retrieve data from a relational	database?		

 SELECT	
 FROM	
	
Question 2:Which of the following database systems recognize the keyword “LIMIT” to limit the number of rows displayed from a query output?

 MySQL

Question 3:Which keywords could you use to determine	the names of the columns contained in	a table?
...
Question 7:What is the color of the Liz Claiborn brand item with the highest SKU # in the Dillard’s database (the Liz Claiborn brand is abbreviated “LIZ CLAI” in the Dillard’s database)?
...
Question 8:What aspect	of the following query	will make the query crash?
...
Question 10:According	to the	strinfo	table,in how many states within the United States are Dillard’s stores
...
Question 12:What was the date	of the	earliest sale in the database	where the sale	price of the item did not equal the original price of the item,	and what was the largest margin (original price minus sale price) of an item sold on that earliest date?
...
Question 13:What register number made	the sale with the highest original price and	highest	sale price	between	the dates of August 1,	2004 and August	10, 2004?Make sure to	sort by	original price	first and sale	price second.
...
Question 14: Which of the following brand names with the word/letters “liz” in them exist in the Dillard’s
